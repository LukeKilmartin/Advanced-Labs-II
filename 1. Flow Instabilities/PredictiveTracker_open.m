function [vtracks,ntracks,meanlength,rmslength] = PredictiveTracker_open(inputnames,threshold,max_disp,bground_name,minarea,invert,noisy)
...
[x,y,t,ang]=ParticleFinder_open(inputnames,threshold,framerange,[], ...
